...
<html lang="pt-br">
  <head>
    ...
    <title>Games · Superhardware Info</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
  ...
  <h1 class="display-5 fw-bold">Notícia de Jogos</h1>
    </br>
    <img class="d-block mx-auto mb-4" src="https://adrenaline.com.br/uploads/chamadas/20JogosNaoDivulgadosEAGamePass.jpg" alt="" width="640" height="360">
    <h1 class="display-5 fw-bold">Game News</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Notícias importantes sobre jogos da atualidade no mundo Gamer</p>
